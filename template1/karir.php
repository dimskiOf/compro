...
<head>
    ...
    <title>TRILLIUN: Kembangkan Karir Anda Bersama Kami</title>
    <meta name="description" content="Trilliun membuka kesempatan bagi siapa saja yang ingin mengembangkan karir serta siap menghadapi tantangan baru untuk hasil yang terbaik." />
    <link rel="canonical" href="https://trilliun.com/careers" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="TRILLIUN: Kembangkan Karir Anda Bersama Kami" />
    <meta property="og:description" content="Trilliun membuka kesempatan bagi siapa saja yang ingin mengembangkan karir serta siap menghadapi tantangan baru untuk hasil yang terbaik." />
    <meta property="og:url" content="https://trilliun.com/careers" />
    ...
    <div class="content">
        <div class="d-flex flex-column justify-content-end pt-md-5 pt-0 justify-content-md-center pb-4 pages-header pages-header-paralax"
            ...
            <div class="d-flex flex-column pages-header-content">
                ...
                <h5 class="text-white d-lg-none d-block">Recruiting, developing and rewarding highly competent people</h5>
            </div>
        </div>
        <div class="d-flex flex-column mx-auto d-block gap-2 py-5 career-desc justify-content-center">
        ...
        <div class="container-fluid-x">
            <div class="container-form d-flex justify-content-center">
                <form method="POST" action="https://trilliun.com/submit-career" accept-charset="UTF-8" id="dform" class="form-career d-flex flex-column"><input name="_token" type="hidden" value="6PMtyQubVQMbw8Xr7kZcTPvBTvrXorztwONeodH4">
                    ...
                    <button type="submit" class="btn-trilliun border-0 bg-trilliun d-block text-white px-5 py-3 mx-auto btnSubmit">
    ...
    $(function() {
        $(window).scroll(function() {
            ...
            if (scrollTop >= 0) {
                ...
                $(".pages-header-paralax").css({
                    'background-position-y': (20 - (translate / 100 * 20)) + "%",
                });
            }
        });
    });
