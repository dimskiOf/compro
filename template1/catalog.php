...
<head>
    ...
    <title>FIGO: Produsen Pipa &amp; Fitting, dan Selang Berkualitas</title>
    <meta name="description" content="Informasi lengkap semua katalog produk pipa, selang MPI dapat Anda akses serta unduh dengan mudah dan cepat di halaman ini." />
    <link rel="canonical" href="catalog.php" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="FIGO: Produsen Selang &amp; Fitting, ember, dan Selang Berkualitas" />
    <meta property="og:description" content="Informasi lengkap semua katalog produk pipa, selang MPI dapat Anda akses serta unduh dengan mudah dan cepat di halaman ini." />
    <meta property="og:url" content="catalog.php" />
    <meta property="og:site_name" content="Figo Group" />
...
<body>
    ...
    <div class="content">
        <div class="d-flex flex-column justify-content-end pt-md-5 pt-0 justify-content-md-center pb-4 pages-header"
            style="background-image:url('assets/image/Catalog/Banner Catalog/PRODUCT CATALOGUE (1)_page-0001.jpg')">
            <div class="d-flex flex-column pages-header-content">
                <p class="text-white p-0 mb-1">REASON <strong>#</strong></p>
                <h5 class="text-white">Premium Hose, Medical Part & etc.</h5>
            </div>
        </div>


        <div class="container-fluid-x pt-4 d-flex flex-column">
            <div class="d-flex flex-wrap my-5 gap-5 mt-4 justify-content-center" style="row-gap:2.5rem !important;">
                <div class="d-flex flex-column gap-3">
                    <a href="catalog-example.php" class="catalog-img">
                        <img src="assets/image/Catalog/Background catalog/PRODUCT CATALOGUE (1)_page-0003.jpg" alt="Foto Thumb Catalog" height="500">
                    </a>
                    <p class="text-center">Catalog <b>Figo </b>Speciality PVC Hose</p>
                </div>
                <div class="d-flex flex-column gap-3">
                    <a href="catalog-example.php" class="catalog-img">
                        <img src="assets/image/Catalog/Background catalog/PRODUCT CATALOGUE (1)_page-0016.jpg" alt="Foto Thumb Catalog" height="500">
                    </a>
                    <p class="text-center">Catalog <b>Figo </b>Heavy Duty PVC Hose</p>
                </div>
                <div class="d-flex flex-column gap-3">
                    <a href="catalog-example.php" class="catalog-img">
                        <img src="assets/image/Catalog/Background catalog/PRODUCT CATALOGUE (1)_page-0010.jpg" alt="Foto Thumb Catalog" height="500">
                    </a>
                    <p class="text-center">Catalog <b>Figo </b>Garden PVC Hose</p>
                </div>
